...
radix define fixed#3#decimal#signed -fixed -fraction 3 -signed -base signed -precision 4
radix define fixed#6#decimal#signed -fixed -fraction 6 -signed -base signed -precision 4
quietly WaveActivateNextPane {} 0
add wave -noupdate /tb_DNN/clk
add wave -noupdate /tb_DNN/DUT/u_DNN_Control/current_state
add wave -noupdate /tb_DNN/rst
add wave -noupdate -radix fixed#3#decimal#signed /tb_DNN/in_feature
add wave -noupdate -radix unsigned /tb_DNN/in_address
add wave -noupdate /tb_DNN/in_start
add wave -noupdate -radix fixed#3#decimal#signed /tb_DNN/out_feature
...
add wave -noupdate -radix fixed#3#decimal#signed /tb_DNN/DUT/u_DNN_MAC/bais
add wave -noupdate -radix unsigned /tb_DNN/DUT/u_DNN_MAC/bais
add wave -noupdate /tb_DNN/DUT/u_DNN_MAC/bais_en
add wave -noupdate /tb_DNN/DUT/u_DNN_MAC/MAC_out
