package LeNet5_pkg;
    ...
    typedef logic signed [15:0] sum_t;     // Q8.6  signed
    typedef logic signed [7:0]  weight_t;  // Q4.3  signed
    typedef logic signed [7:0]  feature_t; // Q4.3  signed
    // Feature Maps
    parameter FLATTEN_LAYER_PARAMETERS = "../../../software/Parameters/Tests/6/FM_2/_flatten_FM2.mem";
    parameter FEATURE_MAP_3_FILE_PATH  = "../../../software/Parameters/Tests/6/FM_3/Feature_Map_3.mem";
    parameter FEATURE_MAP_4_FILE_PATH  = "../../../software/Parameters/Tests/6/FM_4/Feature_Map_4.mem";
